...
PRICE = {
    '1': [types.LabeledPrice(label='Item1', amount=100)],
    '2': [types.LabeledPrice(label='Item2', amount=200)],
    '3': [types.LabeledPrice(label='Item3', amount=300)],
    '4': [types.LabeledPrice(label='Item4', amount=400)],
    '5': [types.LabeledPrice(label='Item5', amount=500)],
    '6': [types.LabeledPrice(label='Item6', amount=600)]
}
